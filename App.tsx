...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen container mx-auto p-4 flex flex-col items-center bg-white">
      <header className="w-full mb-8 text-center">
        <h1 className="text-5xl font-bold text-blue-600">
          AI広告リーガルチェックツール
        </h1>
        <p className="text-gray-700 mt-2 font-medium">広告の法的およびコンプライアンスレビューを自動化します。</p>
        <div className="mt-3">
          <a 
            href="https://www.notion.so/zeals-ai/AI-Ver2-2afd8ab456c081359572e583800c7b84"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-600 hover:text-blue-700 underline text-sm flex items-center justify-center gap-1 transition-colors font-semibold"
          >
      ...
      <main className="w-full max-w-4xl bg-white shadow-lg rounded-xl p-6 border border-gray-200">
        <Stepper currentStep={currentStep} />

        {errorMessage && (
          <div className="bg-red-50 border-l-4 border-red-500 text-red-800 px-4 py-3 rounded relative mb-4 shadow-sm" role="alert">
        ...
        { (currentStep >= AdCheckStep.ProcessingStep1Step2 && currentStep !== AdCheckStep.Input ) && (
         ...
         {currentStep !== AdCheckStep.Input && (
            <button
                ...
                className="mt-8 bg-white hover:bg-gray-50 text-blue-600 font-bold py-3 px-6 rounded-lg transition duration-150 ease-in-out w-full border-2 border-blue-600 shadow-sm hover:shadow-md"
            >
                新しいチェックを開始
            </button>
        )}
      </main>
      <footer className="w-full text-center mt-12 pb-8 text-gray-600 font-medium">
